...
public class MissionDetail extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		System.out.println(mMissionGuid+"  : "+ App.UserCode);
	...
	private void findViewById() {
		mTaskNumTv = (TextView) findViewById(R.id.miss_task_num_tv);
...
//				mDriverTelephoneTv.setText(mMissionInfoList.get(0).getDIRVER());
