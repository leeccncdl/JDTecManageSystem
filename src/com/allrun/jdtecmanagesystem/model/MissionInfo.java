...
public class MissionInfo {
	...
	public String getCOMMUNICTIONCARD() {
		return COMMUNICTIONCARD;
	}
	public void setCOMMUNICTIONCARD(String cOMMUNICTIONCARD) {
		COMMUNICTIONCARD = cOMMUNICTIONCARD;
	}
